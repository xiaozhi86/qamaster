...
| 流程控制 | 状态机、契约卡、门禁裁决、状态分区、MANIFEST 协调、自我进化知识库 | `runtime/{state_store,phases,requirement_review_phases,qamaster_runtime,manifest,locking,kb_store}.py` + `runtime/workflows/` |
